...
# with cols[1]:
    ...
    if n_score != 0:
        ...
        st.sidebar.warning('Neutral deduction of -'+str(n_score) +
                           ' for too short routine.\n Scroll for new final score.')
        st.sidebar.metric(label="Final score",
                          value=str(new_final_score)+" P.")
